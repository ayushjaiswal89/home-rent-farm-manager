...
export function SettingsSection({
  ...
  const reset = () => {
    if (!window.confirm(isHi ? "क्या आप सेटिंग्स रीसेट करना चाहते हैं?" : "Reset all settings?")) {
      return;
    }
  ...
  const toggleRows = [
    ...
    { key: "appLock" as const, label: isHi ? "🔐 App Lock" : "🔐 App Lock", sub: isHi ? "ऐप खोलते समय PIN मांगा जाएगा" : "Ask for PIN when opening the app", },
  ];
          ...
          <FormCard>
            ...
            <div className="space-y-5">
                ...
                <button
                  ...
                  onClick={async () => {
                    ...
                    if (!granted) {
                      alert(
                        isHi
                          ? "Notification permission नहीं मिली। Browser settings में permission allow करें।"
                          : "Notification permission was not granted."
                      );
                    }
                  }}
                  className={`${btnSecondary} w-full mt-5`}
                >
                  🔔{" "}
                  {isHi
                    ? "Notification Permission"
              ...
              {settings.appLock && (
                <div className="mt-4">
                  <InputGroup
                    label={isHi ? "4 अंकों का PIN" : "4-digit PIN"}
                  >
                    <input
                      type="password"
                      inputMode="numeric"
        ...
        <FormCard>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="space-y-6">
              ...
              <div className="text-[11px] sm:text-xs leading-5 text-[var(--sk-faint)]">
          ...
          <div className="border-t border-[var(--sk-border)] mt-4 pt-4 text-[11px] sm:text-xs leading-6 break-words text-[var(--sk-faint)]">
            © 2026 Smart Khaata
            <br />
